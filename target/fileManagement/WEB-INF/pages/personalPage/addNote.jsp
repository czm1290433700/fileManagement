...
<title>${user.username}的个人主页-写笔记</title>
</head>
<body>
			...
			<div class="add-content rounded">
				...
				<form action="" method="post" class="settings-form">
					<table>
						...
						<tr>
							<th>笔记标题:</th>
							<td><input type="text" name="title" class="form-control add-text" placeholder="输入笔记标题"/></td>
						</tr>
						<tr>
							<th>课程分类:</th>
							<td>
								<select class="form-control select" name="courseByCourseId.courseId" id="sel_year">
