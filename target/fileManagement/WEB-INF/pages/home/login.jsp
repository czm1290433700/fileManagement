	...
	<div class="container-fluid body" id="wall">
		<div class="container clearfix" style="padding-top:200px;">
			<div id="login-form">
				...
				<form id="form1" action="/personalPage/home/${user.userId}" method="get" style="margin:auto;" onsubmit="return checkAll()">
                    <input type="hidden" id="result1"/>
                    <input type="hidden" id="result2"/>
                    <input type="hidden" id="result3"/>
					<input type="text" id="phone" name="phone" placeholder="注册手机号" style="font-size:13px;"/>
					<input type="text" id="password" name="password" placeholder="密码" style="font-size:13px;"/>
                    ...
                    <input type="submit" id="add" class="btn btn-primary rounded" value="登录"/>
				</form>
				<form id="form2" class="none-form" action="" method="post" style="margin:auto;">
					<input type="text" name="phone" placeholder="注册手机号" style="font-size:13px;"/>
					<input type="text" name="password" placeholder="短信验证码" style="font-size:13px;width:105px;"/>
