			...
			<div class="allAns col-sm-12">
				...
				<div class="hotSign">
					<ul class="list-inline row">
						<c:if test="${courseEntities.size()<=10}">
							<c:forEach items="${courseEntities}" var="course">
								<li class="col-sm-3"><div class="ans-sign"><a href="/signNote/${course.courseId}/1">${course.name}</a></div></li>
							</c:forEach>
						</c:if>
						<c:if test="${courseEntities.size()>10}">
							<c:forEach items="${courseEntities}" var="course" begin="0" end="9">
								<li class="col-sm-3"><div class="ans-sign"><a href="/signNote/${course.courseId}/1">${course.name}</a></div></li>
							</c:forEach>
						</c:if>
					</ul>
			...
			<div class="col-sm-12">
				...
				<div class="supplyAns-body col-sm-12" style="padding:0px 40px;padding-bottom:40px;">
					...
					<div class="answer-body clearfix">
						...
						<div id="table2">
							<table class="table table-hover" style="font-size:15px;display:none;">
								<tr>
									<td class="answer-title"><a href="/infoNote">C语言的语言特征</a></td>
									<td class="answer-sign">
										<span class="fa fa-mortar-board" style="float:left;margin-top:5px;"></span>
										<span>C语言</span>
									</td>
